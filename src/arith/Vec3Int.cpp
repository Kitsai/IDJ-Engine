...
namespace fyrebird {
    Vec3Int::Vec3Int(integer x, integer y, integer z) {
        this->x = x;
        this->y = y;
        this->z = z;
    }
    ...
    Vec3Int Vec3Int::operator+(const integer &v) const {
    ...
    Vec3Int Vec3Int::normalize() const {
        ...
        return {static_cast<integer>(this->x / m), static_cast<integer>(this->y / m), static_cast<integer>(this->z / m)};
    }
    ...
    Vec3Int Vec3Int::rotate(const float angle) const {
        ...
        return {static_cast<integer>(this->x * c - this->y * s), static_cast<integer>(this->x * s + this->y * c), this->z};
    }
